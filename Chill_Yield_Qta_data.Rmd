...
```{r, echo = F, result = F, fig.width = 4, fig.height = 4}
pasitR::chillkernelslicerange(lapins$Chill_Portions, lapins$Yield, 30, 50)

pasitR::chillkernelslicerange(brooks$Chill_Portions, brooks$Yield, 30, 50)
```
