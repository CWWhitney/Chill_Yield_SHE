...
Often data is limited when assessing the relationship between climate change and yield. Despite this lack of data we are nevertheless required to make assessments and produce useful projections for farmers and decision makers. Perhaps this data limitation does not need to hinder our abilities to assess the relationships between temperature and yield. For course assessments a lot of data may not be necessary. Here we show a method whereby we can embrace the inherint uncertainty in such assessments to overcome the need for preciseness. After all far into the future we have no data. We necesarily have uncertainty in our model forecasts. We use the pasitR package [@R-pasitR] in the R programming language [@R-base].
